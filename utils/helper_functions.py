...
def coord_to_coordlist(coords: list) -> list:
    """Takes a list of coordinates and returns tuples representing each connected edge (closing the polygon)."""
    return list(zip(coords, coords[1:] + [coords[0]]))
